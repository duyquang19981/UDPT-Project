...
(
	ID_NOTI INT IDENTITY(1,1) PRIMARY KEY,
    ID_QUESTION INT,
    ID_ANSWER INT,
...
(
	ID_NA INT IDENTITY(1,1) PRIMARY KEY,
...
(
    ...
    CREATED DATE,
    ACCEPT_DAY DATE,
    REFERENCELINK NVARCHAR(100),
    REFERENCEIMAGE NVARCHAR(100),
    STATUS INT
);
...
(
    ID_CATEGORY_QUES INT IDENTITY(1,1) PRIMARY KEY,
    MOD_ID INT NOT NULL,
    CATEGORY_ID INT,
    NAME NVARCHAR(50),
    CREATED DATE,
...
(
	QL_ID INT IDENTITY(1,1) PRIMARY KEY,
    QUESTION_ID INT NOT NULL,
...
CREATE TABLE LABEL
(
    ID_LABEL INT IDENTITY(1,1) PRIMARY KEY,
    MOD_ID INT NOT NULL,
    DESCRIPTION NVARCHAR(100) NOT NULL,
    STATUS INT 
);
...
ALTER TABLE question ADD FOREIGN KEY(category_id) REFERENCES category_ques(id_category_ques);
...
ALTER TABLE category_ques ADD FOREIGN KEY(category_id) REFERENCES category_ques(id_category_ques);
...
go
INSERT INTO ADMIN(name,username,pass,role,NOTIFICATION_yes,status) VALUES(N'Nguyễn Phạm Anh Tú', 'ADMIN','ADMIN',1,0,1)
INSERT INTO ADMIN(name,username,pass,role,NOTIFICATION_yes,status) VALUES(N'Trần Duy Quang', 'ADMIN1','ADMIN',1,0,1)
INSERT INTO ADMIN(name,username,pass,role,NOTIFICATION_yes,status) VALUES(N'Nguyễn Văn Tâm', 'ADMIN2','ADMIN',1,0,1)
INSERT INTO ADMIN(name,username,pass,role,NOTIFICATION_yes,status) VALUES(N'Lê Quang Quí', 'ADMIN3','ADMIN',1,0,1)
go
INSERT INTO user_account( NAME, email, birth, phone, username, PASSWORD, created ) VALUES( N'Nguyễn Phạm Anh Tú', 'tubato1999@gmail.com', '1999/06/02', '0858456152', 'tubato1999', '123456', '2021/05/08' )
INSERT INTO user_account( NAME, email, birth, phone, username, PASSWORD, created ) VALUES( N'Nguyễn Phúc Thạnh', 'npthanh99@gmail.com', '1999/05/09', '0845775112', 'npthanh99', '123456', '2021/05/08' )
INSERT INTO user_account( NAME, email, birth, phone, username, PASSWORD, created ) VALUES( N'Nguyễn Văn Quân', 'npquan99@gmail.com', '1999/05/09', '0845775634', 'nvquan99', '123456', '2021/05/08' )
INSERT INTO user_account( NAME, email, birth, phone, username, PASSWORD, created ) VALUES( N'Trần Đình Sang', 'tdsang99@gmail.com', '1999/05/09', '084134572', 'tdsang99', '123456', '2021/05/08' )
INSERT INTO user_account( NAME, email, birth, phone, username, PASSWORD, created ) VALUES( N'Nguyễn Phú Quý', 'npquy99@gmail.com', '1999/05/09', '083475142', 'npquy99', '123456', '2021/05/08' )
INSERT INTO user_account( NAME, email, birth, phone, username, PASSWORD, created ) VALUES( N'Nguyễn Chí Thanh', 'ncthanh99@gmail.com', '1999/05/09', '0757425486', 'ncthanh99', '123456', '2021/05/08' )
INSERT INTO user_account( NAME, email, birth, phone, username, PASSWORD, created ) VALUES( N'Nguyễn Văn Quyền', 'nvquyen99@gmail.com', '1999/05/09', '0357426842', 'nvquyen99', '123456', '2021/05/08' )
INSERT INTO user_account( NAME, email, birth, phone, username, PASSWORD, created ) VALUES( N'Huỳnh Tấn Thành', 'htthanh@gmail.com', '1999/05/09', '0357412596', 'htthanh99', '123456', '2021/05/08' )
go
...
go
INSERT INTO CATEGORY_QUES(MOD_ID,CATEGORY_ID,NAME,CREATED,STATUS) VALUES(2,NULL,N'VẤN ĐỀ 1','2021/05/08',1)
INSERT INTO CATEGORY_QUES(MOD_ID,CATEGORY_ID,NAME,CREATED,STATUS) VALUES(1,1,N'VẤN ĐỀ 2','2021/05/08',1)
INSERT INTO CATEGORY_QUES(MOD_ID,CATEGORY_ID,NAME,CREATED,STATUS) VALUES(4,NULL,N'VẤN ĐỀ 3','2021/05/08',1)
INSERT INTO CATEGORY_QUES(MOD_ID,CATEGORY_ID,NAME,CREATED,STATUS) VALUES(3,NULL,N'VẤN ĐỀ 4','2021/05/08',1)
INSERT INTO CATEGORY_QUES(MOD_ID,CATEGORY_ID,NAME,CREATED,STATUS) VALUES(1,4,N'VẤN ĐỀ 5','2021/05/08',1)
INSERT INTO CATEGORY_QUES(MOD_ID,CATEGORY_ID,NAME,CREATED,STATUS) VALUES(1,NULL,N'VẤN ĐỀ 6','2021/05/08',1)
INSERT INTO CATEGORY_QUES(MOD_ID,CATEGORY_ID,NAME,CREATED,STATUS) VALUES(1,6,N'VẤN ĐỀ 7','2021/05/08',1)
GO
