...
if(
    ...
    $likes->question_id = $data->question_id;
    ...
    if($jwt){
        ...
        try {
            ...
            try {
                $num = $likes->check_ques();
                if($num < 1)
                {
                    $check = $likes->create_ques();
                    if($check == 1)
                    {
                        $ques = new question($db);
                        $ques->id_question = $likes->question_id;
                        $li = $ques->get_like();
                        $check1 = $ques->update_like($li+1);
                        if($check1 == 1)
                        {
