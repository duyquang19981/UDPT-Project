...
<script src="<?php echo _PUBLIC ?>/js/admin-crud/admin-crud-nhan.js"></script>
    ...
    <div class="table-wrapper">
      ...
      <table class="table table-striped table-hover">
        <thead>
          <tr>
            <th>Mã</th>
            <th style="width:1px;">Tên nhãn</th>
            <th>Trạng thái</th>
            <th>Admin tạo</th>
          </tr>
        </thead>
          ...
          if (isset($data["Labels"]) && count($data["Labels"]) > 0) {
            foreach ($data["Labels"] as $label) { ?>
              <tr>
                ...
                <td><?php echo trim($label["description"]); ?></td>
...
<div id="editRecord" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <form id="edit_form" method="POST" action="<?php echo _WEB_ROOT ?>/Label/Update">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="form-group">
            <label>Tên</label>
            <input id="edit_input_id" style="display:none" name="id_label" type="text">
            <input id="edit_input_ten" name="label_description" type="text" class="form-control" required maxlength="30">
...
<div id="deleteRecord" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <form name="deleteForm" method="POST" action="<?php echo _WEB_ROOT ?>/Label/Delete">
        <div class="modal-header">
        ...
        <div class="modal-footer">
          <input id="delete_input_id" name="id_label" type="text" style="display: none;">
          <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
